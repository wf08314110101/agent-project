...
| [react-node-agentic-rag](react-node-agentic-rag/README.md) | React + Node.js Agentic RAG | React + Node.js + LangGraph | Graph-based Agent、检索路由、记忆机制、文档处理流水线 |
...
# 访问 http://localhost:5173 体验对话和文档检索
```
...
- **react-node-agentic-rag**：基于 LangGraph 的 Agent 图结构、Qdrant 向量存储、SQLite 会话管理、OpenTelemetry 可观测性
